...
public class EppPage extends BaseTest {
	...
	//*****LOGOUT MENU******
	public  static WebElement logMenu(){
		WebElement element=driver.findElement(By.xpath(properties.getProperty("logMenu")));
		return element;
	}
	public  static WebElement edit_PP(){
		WebElement element=driver.findElement(By.xpath(properties.getProperty("edit_PP")));
		return element;
	}
	public  static WebElement editProfile(){
		WebElement element=driver.findElement(By.xpath(properties.getProperty("editProfile")));
		return element;
	}
	//************Edit Profile
	public  static WebElement horoscope_AddLeftBtn(){
		WebElement element=driver.findElement(By.xpath(properties.getProperty("horoscope_AddLeftBtn")));
		return element;
	}
	public  static WebElement horoDeleteBtn(){
		WebElement element=driver.findElement(By.xpath(properties.getProperty("horoDeleteBtn")));
		return element;
	}
	//*****MARITAL STATUS*****
	...
	public static void loadProperties()throws Throwable{
    	...
    	properties.load(fis);
    	FileInputStream fis1 = new FileInputStream(new File(".\\ObjectRepository\\Matches.properties"));
