...
public class WhoShortlistedMeTest extends BaseTest {
	public static Properties properties;
	public WhoShortlistedMeTest() throws Throwable{
		HomePage.loadProperties();
		WhoShortlistedMePage.loadProperties();
	}
	@Test
	public  void shortlistedMeTest() throws Throwable{
		test=extent.createTest("Who shortlisted me Test ");
		LoginPage2.login();
		LoginPage2.intermediate_Popups();
		Thread.sleep(2000);
		Actions act=new Actions(driver);
		act.moveToElement(HomePage.myHomeLink()).perform();
		act.moveToElement(WhoShortlistedMePage.whoShortlistMe()).click().perform();
		test.pass("clicked on who shortlisted me ");
		...
		if(idListSize>0){
			...
			test.pass("who shortlisted me is verified successully");
		}
		else{
			test.pass("sorry, there is no shortlisted profiles for this id");
		}	
		driver.close();
	}
