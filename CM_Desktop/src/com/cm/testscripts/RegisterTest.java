...
public class RegisterTest extends BaseTest{
	...
	public static void registerTest() throws Exception{
		System.out.println("Registration Module Testing.....");
		...
		for (int i=3; i<=3; i++) {
			...
			Thread.sleep(2000);
				...
				//registerPage1 test data from excel file 1
					...
					String  mobileno=sheet1.getRow(i).getCell(18).getStringCellValue()+Math.round(Math.random()*899);
				...
				//registerPage2 test data from excel file 2
					...
					// fatherOccup=sheet2.getRow(i).getCell(39).getStringCellValue();
...
BussinessFunctions.registrationPage1( driver, properties, communitysite, profileby, name,gender,date1, month, year, martial, relgion,denominations, 
		 ...
		 driver.findElement(By.cssSelector("body")).sendKeys(Keys.CONTROL +"t");
	       ...
	       Thread.sleep(1000);	        
	        String pinNum=pinnotext.substring(24,30);
	       ...
	       // driver.navigate().back();
	        Thread.sleep(1000);
	        driver.findElement(By.xpath(".//*[@id='pinNo']")).sendKeys(pinNum);
