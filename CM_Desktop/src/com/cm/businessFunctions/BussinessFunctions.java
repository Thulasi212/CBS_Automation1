package com.cm.businessFunctions;
...
import com.cm.Utility.ActionDrivers;
import com.cm.pages.AdvSearchPage;
import com.cm.pages.DailyMatchePage;
import com.cm.pages.EditProfilePage;
import com.cm.pages.FaceBookPage;
import com.cm.pages.IntermidatePages;
import com.cm.pages.KeyWordSearch;
import com.cm.pages.LoginPage;
import com.cm.pages.RegisterPage1;
import com.cm.pages.RegisterPage2;
import com.cm.pages.ViewProfilesPage;
public class BussinessFunctions extends ActionDrivers{
	...
	public static  String  randomSelection(WebDriver driver){
		...
		System.out.println("Visted are : "+visited);
...
selectElementByVisibleText(RegisterPage2.HighestEducation_dd(driver, properties.getProperty("HighestEducation_dropdown")),highestEdu);
	...
	throws Exception{
		...
		type(RegisterPage2.AnnualIncome_Text(driver, properties.getProperty("AnnualIncome_Text")),annualIncome);
...
public static void navigationURL(WebDriver driver) throws Exception
{
