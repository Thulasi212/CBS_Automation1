...
public class ExcelData {
	...
	public String getExcelData(String sheetName, int rowNum, int colNum) throws Throwable{
		FileInputStream fis = new FileInputStream(".CBSIOS_3.1//Resources//IOS_LoginTestdata.xls");
	...
	public String getExcelData(String sheetLocation,String sheetName, int rowNum, int colNum) throws Throwable{
	...
	public int getExcelRandomRowNum(String sheetLocation,String sheetName) throws Throwable{
		FileInputStream fis = new FileInputStream(sheetLocation);
        Workbook wb = WorkbookFactory.create(fis);
        Sheet sh = wb.getSheet(sheetName);
