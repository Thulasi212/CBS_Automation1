...
public class Base {
	...
	public static List<HashMap<String, String>> readValueFromExcelSheet() throws NullPointerException {
		...
		try {
			File excelLocaltion = new File("E:\\workspaceN\\CBSIOS_3.1\\Resources\\IOS_LoginTestdata.xlsx");
	...
	public static String getExcelData(String sheetName, int rowNum, int colNum) throws Throwable {
		FileInputStream fis = new FileInputStream("E:\\workspaceN\\CBSIOS_3.1\\Resources\\IOS_LoginTestdata.xlsx");
	 ...
	 * throws Throwable{ FileInputStream fis = new FileInputStream(
	 * "C:\\Users\\Jyothi\\.eclipse\\Android5.3\\Excel\\city_values.xlsx"); Workbook
	 * wb = WorkbookFactory.create(fis); Sheet sh = wb.getSheet(sheetName); Row row
	 * = sh.getRow(rowNum); String data = row.getCell(colNum).getStringCellValue();
	...
	public void screenShot(ITestResult result) {
		...
		if (ITestResult.FAILURE == result.getStatus()) {
			try {
				// String path =
				// "C:\\Users\\amuthan\\eclipse-workspace\\CBS_Android\\Screenshot\\"+
				// result.getName()+".png";
				TakesScreenshot screenshot = (TakesScreenshot) driver;
				File src = screenshot.getScreenshotAs(OutputType.FILE);
				FileUtils.copyFile(src, new File("C:\\Users\\amuthan\\eclipse-workspace\\CBS_Android\\Screenshot\\"
						+ result.getName() + ".png"));
				// "C:\\Users\\amuthan\\eclipse-workspace\\CBS_Android\\Screenshot\\"+
				// result.getName()+".png"));
